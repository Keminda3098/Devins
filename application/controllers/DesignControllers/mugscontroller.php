...
class Mugscontroller extends CI_Controller {
...
$this -> load -> model('design_request_db');
		...
		$data['font_size'] = $font_size_array;
			if ($this -> form_validation -> run() == FALSE) {
				...
				$this -> load -> model('design_request_db');
				$designtype='mugs';
				$this -> design_request_db -> Insertmugsdesignonlinerequest($amounttext,$datetext,$urlimage,$pricetext,$mobile,$textdescrpt,$designtype,$size,$username);
