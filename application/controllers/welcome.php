...
//-------------------Kemindas-----------------------------------------------------//
  ...
  else if ($this -> input -> get('page') == "choose") {
		...
		$this -> load -> view('common/header');
				$this -> load -> view('design_products/customize_design');
				$this -> load -> view('common/footer');
			} 
  /////////////////////////////////-----FOR THE NAVIDATION BAR//////////////////////////////////////////
    ...
    else if ($this -> input -> get('page') == "customdesign") {
...
//////////////////////////////////////////////////////////////////////////////////////////////
	public function loadcustomizebagspage() {

		$this -> load -> model('design_request_db');
	$data = array('pname' => '', 'pcategory' => '', 'peprice' => '', 'pdate' => '', 'pfile' => '', 'pimg' => '', 'main_content' => 'design_products/customize', 'active' => 'home');
		$data['locat'] = $this -> design_request_db -> getallBagslocation();
		$data['subcato'] = $this -> design_request_db -> getprmprdctcatogoriesToView();
		$data ['urlname'] ="";
		...
		$this -> load -> view('design_products/customize_bags', $data);
	...
	public function download_qr_image() {
		if ($this -> input -> is_ajax_request()) {
			$qr_image = $this -> input -> get('qr_image');
			$imageData = file_get_contents($qr_image);
			$this -> load -> helper('string');
			$random_name = random_string('alnum', 16);

			file_put_contents(getcwd() . '/uploads/images/' . $random_name . '.png', $imageData);

			echo base_url() . 'uploads/images/' . $random_name . '.png';
		}
