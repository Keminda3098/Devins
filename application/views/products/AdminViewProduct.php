			...
			<div class="wrap">
				...
				<div class="cont span_2_of_3"style="padding-top: 24px">
					<table style="width:100%">
						<tr>
							<td>
								<h4 class="title"> &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;Product Feedback</h4> 
							</td>
	 ...
	 <?php 
		...
		{?>
          ...
          <td><span style="font-size: 16px">
            ...
            <option value="1">Product Feedbacks</option>
						<option value="2">Website Feedbacks</option>
						...
						<?php echo form_hidden('selection','product');
						echo form_close(); ?>
				...
				<tr>
								...
								<?php foreach($query ->result() as $row) { ?>
									<tr onMouseOver="this.className='hoverhighlight'" onMouseOut="this.className='hovernormal'">
										...
										<td style="padding: 5px"><?php print $row -> feedback; ?></td>
										<td> 	<a href="<?php echo base_url()."index.php/adminViewProduct/delete/".$row->f_Id; ?>" class="confirmation">Delete</a>	</td>
