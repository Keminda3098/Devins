                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="example2_wrapper">
                                                                                               ...
                                                                                               <?php echo  form_open_multipart('ProfileControllers/SessionDetailCaller/calldropdown')?>  
                                                                                                    <select name ="selectn" class="form-control">
            <?php 
...
$datevalue= mdate($datestring, $row->session_start);
            foreach($groups1 as $row2)
            { 
...
$i=1;
                                                                                                                foreach ($query as $row) {
                                                                                                                    ...
                                                                                                                    <tr class="odd" role="row">
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                         <?php $datestring = "%Y / %m / %d - %h:%i %a" ;
                                                                                                                          date_default_timezone_set('Asia/Kolkata');
                                                                                                                            echo mdate($datestring,$row->session_start);
                                                                                                                            ?> 
                                                                                                                        </td>
                                                                                                                        <td> <?php
                                                                                                                            if ($row->session_end == 0) {
                                                                                                                                echo '0';
                                                                                                                            } else {
                                                                                                                                echo mdate($datestring, $row->session_end);
                                                                                                                            }
                                                                                                                            ?></td>
                                                                                                                        <td class="sorting_1"><?php print $row->user_agent; ?></td>
                                                                                                                        <td>                                                                                                                     

                                                                                                                                    <?php if ($row->session_end == 0) { ?>
