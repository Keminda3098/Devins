...
if($paymentStatus=="Completed"){
	...
	mysqli_query($con,"UPDATE `order` SET `payment_state`='1' where `username` = '$username' and `payment_state`='0'");
	...
	header("Location: ../states.php?order=1");
	//echo "1";	
}else{
	//echo "no ela";
	header("Location: ../states.php?order=0");
	//echo "0";
}
?>
