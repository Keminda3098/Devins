...
if ( $PaymentOption == "PayPal")
{
        ...
        //' Shipping page.
        //'------------------------------------
        $shipToName = $_SESSION["name"];
        $shipToStreet = $_SESSION["address"];
        $shipToStreet2 = ""; //Leave it blank if there is no value
        $shipToCity = $_SESSION["line2"];
        $shipToState = $_SESSION["state"];
        $shipToCountryCode = "LK"; // Please refer to the PayPal country codes in the API documentation
        $shipToZip = $_SESSION["zip_postal"];
