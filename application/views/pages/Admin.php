   ...
   <body>
      <div height="1050px">
         <div class="wrap">
                     ...
                     <div style="height: 700px;" class="jspContainer">
                        <div style="padding: 18px; top: 0px; left: 0px;" class="jspPane">
                          ...
                          <div class="buttonside">
                              ...
                              <input name="sliderinfo" value="User Management" type="submit">
                              </a>
                           </div>
                           ...
                           <div class="clear"></div>
                           <div class="buttonside">
                              <a href="<?php echo base_url()?>index.php?page=admindesign">
            ...
            <div class="cont span_2_of_3"style="padding-top: 124px">
               <div class="cont1">
               </div>
               <div class="clear"></div>
            </div>
