                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <table width="630px" >
                                                <tr>
                                                    ...
                                                    <?php echo form_open_multipart('DesignControllers/Uploadforshirtdesign/do_upload'); ?>
                                                    ...
                                                    <?php echo form_close(); ?>
                                                    <?php echo form_open('DesignControllers/Shirtscontroller'); ?>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300">
                                                        <input type="number" step="any" name="pricetext" value ="<?php echo set_value('pricetext') ?>" maxlength="10" /> </td>
                                        ...
                                        <td>
                                            ...
                                            <table width="470px" height="100px" bgcolor="#000000" >
                                                <?php echo form_open('DesignControllers/imagedisplayer'); ?>
                                                <tbody>
                                                    <tr><span class='zoom' id='ex1'>
                                                            ...
                                                            <?php foreach ($locat as $row) { ?>
                                                                ...
                                                                <img src="<?php print $row->templocation; ?>" style="width:450px; height:450px; " id="myImage"   >

                                                                    <img src="<?php print $row->templocation2; ?>" style="width:450px; height:450px; " id="myImage2"   >
                                                                    ...
                                                                    <table  width="300px" >
                                                                        <? form_open('DesignControllers/Shirtscontroller') ?>
                                                                        ...
                                                                        <table border="1"  width="175px"  >
                                                                            <tr>
                                                                                ...
                                                                                <td  width="35px" height="60px">
                                                                                    ...
                                                                                    <input type="submit"  name="submitwhitefront"  value="..." style="background-color:#f6f6f6; color:#f6f6f6 ;border:none">

                                                                                </td>
                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit"  name="submityellowfront"  value="..." style="background-color:#f2ba00; color:#f2ba00;border:none">

                                                                                </td>
                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit"  name="submitgreenfront"  value="..." style="background-color:#008946; color:#008946;border:none">

                                                                                </td> 
                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit"  name="submitpurplefront"  value="..." style="background-color:#71387d; color:#71387d;border:none">

                                                                                </td>
                                                                                <td  width="35px" height="60px">  

                                                                                    <input type="submit"  name="submitredfront"  value="..." style="background-color:#cc0d1a; color:#cc0d1a;border:none">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td  width="35px" height="60px"> 
                                                                                    <input type="submit" name="submitdarkbluefront" value="..." style="background-color:#373f54; color:#373f54;border:none; " >

                                                                                </td>
                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit" name="submitgreyfront" value="..." style="background-color:#b8b8b8; color:#b8b8b8;border:none; " >

                                                                                </td>
                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit"  name="submitbrownfront"  value="..." style="background-color:#534631; color:#534631;border:none">

                                                                                </td>

                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit"  name="submitblackfront"  value="..." style="background-color:#313131; color:#313131;border:none">

                                                                                </td>
                                                                                <td  width="35px" height="60px">

                                                                                    <input type="submit"  name="submitbluefront"  value="..." style="background-color:#3a3d87; color:#3a3d87;border:none">
