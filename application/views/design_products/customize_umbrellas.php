                                    ...
                                    <tr>
                                        ...
                                        <td></br>
                                            ...
                                            <table width="630px" >
                                                <tr>
                                                    ...
                                                    <?php echo form_open_multipart('DesignControllers/Uploadforbrelladesign/do_upload'); ?>
                                                    ...
                                                    <?php echo form_close(); ?>
                                                    <?php echo form_open('DesignControllers/Umbrellacontroller'); ?>
                                                </tr>
                                                <tr>
                                        ...
                                        <td>
                                            ...
                                            <table width="470px" height="100px" bgcolor="#000000" >
                                                <?php echo form_open('DesignControllers/Umbrellasimagedisplayer'); ?>
                                                <tbody>
                                            ...
                                            <table  width="300px" >
                                                <? form_open('DesignControllers/umbrellacontroller') ?>
                                                ...
                                                <?php echo form_close(); ?>
                                                <?php echo form_open('DesignControllers/umbrellaimagedisplayer'); ?>
                                            </table>	
                                        </td>
                                        <td>
                                            <table border="1"  width="175px"  >
                                                <tr>
                                                    ...
                                                    <td  width="35px" height="60px">
                                                        ...
                                                        <input type="submit"  name="submitwhitefrontumb"  value="..." style="background-color:#f6f6f6; color:#f6f6f6 ;border:none">

                                                    </td>
                                                    <td  width="35px" height="60px">

                                                        <input type="submit"  name="submityellowfrontumb"  value="..." style="background-color:#f2ba00; color:#f2ba00;border:none">

                                                    </td>
                                                    <td  width="35px" height="60px">

                                                        <input type="submit"  name="submitgreenfrontumb"  value="..." style="background-color:#008946; color:#008946;border:none">

                                                    </td> 
                                                    <td  width="35px" height="60px">

                                                        <input type="submit"  name="submitpurplefrontumb"  value="..." style="background-color:#71387d; color:#71387d;border:none">

                                                    </td>
                                                    <td  width="35px" height="60px">  

                                                        <input type="submit"  name="submitredfrontumb"  value="..." style="background-color:#cc0d1a; color:#cc0d1a;border:none">
                                                ...
                                                <tr>
                                                    ...
                                                    <td  width="35px" height="60px"> 
                                                        <input type="submit" name="submitdarkbluefrontumb" value="..." style="background-color:#373f54; color:#373f54;border:none; " >

                                                    </td>
                                                    <td  width="35px" height="60px">

                                                        <input type="submit" name="submitgreyfrontumb" value="..." style="background-color:#b8b8b8; color:#b8b8b8;border:none; " >

                                                    </td>
                                                    <td  width="35px" height="60px">

                                                        <input type="submit"  name="submitbrownfrontumb"  value="..." style="background-color:#534631; color:#534631;border:none">

                                                    </td>

                                                    <td  width="35px" height="60px">

                                                        <input type="submit"  name="submitblackfrontumb"  value="..." style="background-color:#313131; color:#313131;border:none">

                                                    </td>
                                                    <td  width="35px" height="60px">

                                                        <input type="submit"  name="submitbluefrontumb"  value="..." style="background-color:#3a3d87; color:#3a3d87;border:none">
