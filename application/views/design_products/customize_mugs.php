                        ...
                        <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,800' rel='stylesheet' type='text/css'>
                            ...
                            <body>
                                    ...
                                    <tr>
                                        ...
                                        <td></br>
                                            ...
                                            <table width="630px" >
                                                <tr>
                                                    ...
                                                    <?php echo form_open_multipart('DesignControllers/Uploadformugdesign/do_upload'); ?>
                                                    ...
                                                    <?php echo form_close(); ?>
                                                    <?php echo form_open('DesignControllers/Mugscontroller'); ?>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300">
                                                        <input type="text" name="pricetext" value ="<?php echo set_value('pricetext') ?>" /> </td>
                                                    <td width="329"> <div class="error"><?php echo form_error('pricetext'); ?></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td  scope="row" style="font-size: 12px">Expected Amount</td>
                                                    <td width="300"><input type="text" name="amounttext"  value ="<?php echo set_value('amounttext') ?>" /> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300"><input type="text" name="mobile"  value ="<?php echo set_value('mobile') ?>" />
                                                    </td><td>
                                        ...
                                        <th>
                                            ...
                                            <table width="470px" height="100px" bgcolor="#000000" >
                                                <?php echo form_open('DesignControllers/Mugsimagedisplayer'); ?>
                                                <tbody>
                                                    <tr><span class='zoom' id='ex1'>
                                                            ...
                                                            <?php foreach ($locat as $row) { ?>
                                                                ...
                                                                <img src="<?php print $row->templocation; ?>" style="width:590px; height:270px; " id="myImage"   >
                                            ...
                                            <table  width="300px" >
                                                <? form_open('DesignControllers/Mugscontroller') ?>
                                                ...
                                                <table border="1"  width="175px"  >
                                                    <tr>
                                                        ...
                                                        <td  width="35px" height="60px">
                                                            ...
                                                            <input type="submit"  name="submitwhitefrontmug"  value="..." style="background-color:#f6f6f6; color:#f6f6f6 ;border:none">

                                                        </td>
                                                        <td  width="35px" height="60px">

                                                            <input type="submit"  name="submityellowfrontmug"  value="..." style="background-color:#f2ba00; color:#f2ba00;border:none">

                                                        </td>
                                                        <td  width="35px" height="60px">

                                                            <input type="submit"  name="submitgreenfrontmug"  value="..." style="background-color:#008946; color:#008946;border:none">

                                                        </td> 
                                                        <td  width="35px" height="60px">

                                                            <input type="submit"  name="submitpurplefrontmug"  value="..." style="background-color:#71387d; color:#71387d;border:none">

                                                        </td>
                                                        <td  width="35px" height="60px">  

                                                            <input type="submit"  name="submitredfrontmug"  value="..." style="background-color:#cc0d1a; color:#cc0d1a;border:none">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  width="35px" height="60px"> 
                                                            <input type="submit" name="submitdarkbluefrontmug" value="..." style="background-color:#373f54; color:#373f54;border:none; " >

                                                        </td>
                                                        <td  width="35px" height="60px">

                                                            <input type="submit" name="submitgreyfrontmug" value="..." style="background-color:#b8b8b8; color:#b8b8b8;border:none; " >

                                                        </td>
                                                        <td  width="35px" height="60px">

                                                            <input type="submit"  name="submitbrownfrontmug"  value="..." style="background-color:#534631; color:#534631;border:none">

                                                        </td>

                                                        <td  width="35px" height="60px">

                                                            <input type="submit"  name="submitblackfrontmug"  value="..." style="background-color:#313131; color:#313131;border:none">

                                                        </td>
                                                        <td  width="35px" height="60px">

                                                            <input type="submit"  name="submitbluefrontmug"  value="..." style="background-color:#3a3d87; color:#3a3d87;border:none">
                                ...
                                <div class="div-left">
                                    ...
                                    <canvas id="canvas"  width="800px" height="600px" style="border:1px solid #000; background-color:#FFE862;border-color: #red "></canvas>
                                                            ...
                                                            $(document).ready(function () {
                                                                ...
                                                                $('#generate_qr_code').click(function () {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        $.ajax({
                                                                            url: "<?= base_url(); ?>site/download_qr_image",
                                                                            type: 'GET',
                                                                            data: custom_data,
