...
class CI_Session {
    ...
    function sess_write() {
        ...
        foreach (array('session_id', 'ip_address', 'user_agent','session_start','session_end','login_attempt', 'username') as $val) {
...
$username='';
    ...
    function sess_update($login_attempt='') {
        ...
        if ($this->CI->input->is_ajax_request() OR ( $this->userdata['session_start'] + $this->sess_time_to_update) >= $this->now) {
            return;
        }
        ...
        if ($this->sess_use_database === TRUE) {
            ...
            $cookie_data = array();
            foreach (
                    array('session_id', 'ip_address', 'user_agent', 'session_start','session_end','username','login_attempt') as $val) {
                $cookie_data[$val] = $this->userdata[$val];
            }

            $this->CI->db->query($this->CI->db->update_string($this->sess_table_name, 
                    array('session_start' => $this->now,
